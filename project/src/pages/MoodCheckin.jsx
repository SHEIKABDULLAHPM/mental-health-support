...
const MoodCheckin = () => {
  ...
  const trendLabel = trendData?.summary?.label || trendData?.overall_trend || 'stable';
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-gray-700 animate-fade-in" style={{animationDelay: '180ms'}}>
            ...
            <div className="flex justify-end mt-3">
              <button
                ...
                disabled={!notes.trim() || isSentimentLoading}
                className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${
                  notes.trim() && !isSentimentLoading ? 'bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200' : 'bg-gray-200 dark:bg-gray-700 text-gray-400 cursor-not-allowed'
                }`}
              >
              ...
              <div className="mt-4 p-4 border border-red-200 dark:border-red-800 rounded-xl bg-red-50 dark:bg-red-900/20">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    ...
                    >
                      <RefreshCw className={`w-4 h-4 ${isSentimentLoading ? 'animate-spin' : ''}`} />
                ...
                {!trendLoading && trendData && (
                  <>
                    <div className="text-sm text-gray-600 dark:text-gray-300 mb-2">
                      Status: <span className={`font-semibold ${trendLabel === 'improving' ? 'text-green-600 dark:text-green-400' : trendLabel === 'declining' ? 'text-red-600 dark:text-red-400' : 'text-gray-600 dark:text-gray-300'}`}>{trendLabel}</span>
                    </div>
                    <MoodTrendChart
