...
import { formatFullDate, formatShortTime } from '../utils/dateTime';
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-gray-700">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-sm text-gray-600 dark:text-gray-300">
              {trendData ? (
                <span>
                  Status: <span className={`font-semibold ${trendLabel === 'improving' ? 'text-green-600 dark:text-green-400' : trendLabel === 'declining' ? 'text-red-600 dark:text-red-400' : 'text-gray-700 dark:text-gray-200'}`}>{trendLabel}</span>
                </span>
              ) : (
